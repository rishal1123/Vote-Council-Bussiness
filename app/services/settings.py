...
DEFAULT_COLUMNS = {
    ...
    "current_location": {"label": "Current Location", "order": 10, "list": False, "print": False, "pdf": False, "detail": True},
    "box": {"label": "Registered Box", "order": 11, "list": True, "print": True, "pdf": True, "detail": True},
    "box_number": {"label": "Box#", "order": 12, "list": False, "print": True, "pdf": True, "detail": True},
    "zone": {"label": "Zone", "order": 13, "list": False, "print": False, "pdf": True, "detail": True},
    "focals": {"label": "Focal(s)", "order": 14, "list": True, "print": True, "pdf": True, "detail": True},
    "focal_comment": {"label": "Focal Comment", "order": 15, "list": False, "print": False, "pdf": False, "detail": True},
    "remarks": {"label": "Remarks", "order": 16, "list": False, "print": False, "pdf": False, "detail": True},
    "pledged": {"label": "Pledged", "order": 17, "list": True, "print": True, "pdf": True, "detail": True},
    "vote_status": {"label": "Vote Status", "order": 18, "list": True, "print": True, "pdf": True, "detail": True},
}
